...
In my previous post, [Blogging with Hugo and Azure Part 2](../blogging-with-hugo-2), I created a simple YAML pipeline for building and deploying this blog to Azure Storage. It's shown below.
